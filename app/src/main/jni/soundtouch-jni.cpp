...
extern "C" DLL_PUBLIC jstring Java_com_example_karaoke_soundtouch_SoundTouch_getVersionString(JNIEnv *env,
                                                                                              jclass type)
{
    const char *verStr;
...
extern "C" DLL_PUBLIC jlong Java_com_example_karaoke_soundtouch_SoundTouch_newInstance(JNIEnv *env,
                                                                                       jclass type)
{
...
extern "C" DLL_PUBLIC void Java_com_example_karaoke_soundtouch_SoundTouch_deleteInstance(JNIEnv *env, jobject thiz, jlong handle)
{
...
extern "C" DLL_PUBLIC void Java_com_example_karaoke_soundtouch_SoundTouch_setTempo(JNIEnv *env, jobject thiz, jlong handle, jfloat tempo)
{
	SoundTouch *ptr = (SoundTouch*)handle;
	ptr->setTempo(tempo);
}
...
extern "C" DLL_PUBLIC void Java_com_example_karaoke_soundtouch_SoundTouch_setPitchSemiTones(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
	SoundTouch *ptr = (SoundTouch*)handle;
...
extern "C" DLL_PUBLIC void Java_com_example_karaoke_soundtouch_SoundTouch_setSpeed(JNIEnv *env, jobject thiz, jlong handle, jfloat speed)
{
	SoundTouch *ptr = (SoundTouch*)handle;
	ptr->setRate(speed);
}
...
extern "C" DLL_PUBLIC jstring Java_com_example_karaoke_soundtouch_SoundTouch_getErrorString(JNIEnv *env,
                                                                                            jclass type)
{
...
Java_com_example_karaoke_soundtouch_SoundTouch_processFile__JLjava_lang_String_2Ljava_lang_String_2(JNIEnv *env, jobject thiz, jlong handle, jstring jinputFile, jstring joutputFile)
{
	SoundTouch *ptr = (SoundTouch*)handle;
